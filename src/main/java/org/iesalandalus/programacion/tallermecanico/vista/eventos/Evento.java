...
public enum Evento {
    ...
    INSERTAR_REVISION(31, "Insertar trabajo de revision"),
    INSERTAR_MECANICO(32, "Insertar trabajo mecánico"),
    BUSCAR_TRABAJOS(33, "Buscar trabajo"),
    BORRAR_TRABAJOS(34, "Borrar trabajo"),
    LISTAR_TRABAJOS(35, "Listar trabajos"),
    LISTAR_TRABAJOS_CLIENTE(36, "Listar trabajos de un cliente"),
    LISTAR_TRABAJOS_VEHICULO(37, "Listar trabajos de un vehiculo"),
    ANADIR_HORAS_TRABAJO(38, "Añadir horas a un trabajo"),
    ANADIR_PRECIO_MATERIAL_TRABAJO(39, "Añadir precio material de un trabajo"),
